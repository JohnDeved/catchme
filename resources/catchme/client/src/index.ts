import alt, { Entity, Player, Blip, PointBlip, RadiusBlip, Vehicle } from 'alt'
import { setPedIntoVehicle, setPedConfigFlag, setEntityInvincible, setVehicleBodyHealth, setVehicleFixed } from 'natives';
...
alt.onServer('healVehicle', (veh: Vehicle) => {
